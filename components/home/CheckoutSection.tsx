    ...
    <section className="checkout py-20 bg-[#f3f4f6]" id="checkout">
      <div className="container" ref={sectionRef}>
        ...
        <div className={`checkout-container flex flex-wrap gap-8 justify-center items-start stagger-item ${isVisible ? 'visible' : ''}`}>
          <div className="checkout-form w-full max-w-md">
            <form id="checkout-form" onSubmit={e => e.preventDefault()} className="space-y-6">
              ...
              <p className="form-disclaimer text-xs text-gray-500">
                ...
                <a href="/terms" className="text-[#2c2d5a] hover:text-[#ff3366] underline">Terms of Service</a> and{' '}
                <a href="/privacy" className="text-[#2c2d5a] hover:text-[#ff3366] underline">Privacy Policy</a>.
              </p>
            </form>
          ...
          <div className="selected-plan-summary w-full max-w-sm bg-white rounded-lg p-6 shadow-lg">
            <h3 className="text-lg font-semibold text-[#2c2d5a] mb-4 flex justify-between items-center">
              Your Selected Plan 
            ...
            <p className="flex justify-between text-lg font-bold text-[#2c2d5a]">Total <span className="text-[#ff3366]">${selectedPriceOption.price.toFixed(2)}</span></p>
            <div className="trust-guarantee mt-4 text-xs text-gray-600 space-y-1">
