...
const TESTIMONIALS_DATA: Testimonial[] = [
  ...
  },
  {
    ...
    location: "Austin, TX",
    text: "As a creative agency managing 12 Adobe licenses, CheapCC has been a game-changer. We've cut our software costs by 75% without compromising on functionality. The instant delivery and genuine Adobe accounts make this the smartest business decision we've made.",
    rating: 5,
    verified: true,
    savings: "$15,600/year",
  ...
  },
  {
    ...
    location: "Chicago, IL",
    text: "CheapCC transformed my freelance business economics. Instead of paying Adobe's premium rates, I invest those savings back into my business. The activation was instant, and I've had zero downtime in 20 months of usage.",
    rating: 5,
    verified: true,
    savings: "$1,800/year",
