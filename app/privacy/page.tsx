...
export default function PrivacyPolicy() {
  return (
    <section className="privacy-section py-16 bg-[#f8f9fa]">
      <div className="container">
        <div className="section-heading text-center mb-8">
          <h1 className="text-3xl font-bold text-[#2c2d5a] mb-2">Privacy Policy</h1>
          <p className="text-gray-500">Last updated: June 1, 2024</p>
        </div>
        <div className="privacy-content max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
          <div className="privacy-block mb-8">
            <h2 className="text-xl font-semibold text-[#2c2d5a] mb-3">1. Introduction</h2>
          ...
          <div className="privacy-block mb-8">
            <h2 className="text-xl font-semibold text-[#2c2d5a] mb-3">2. Information We Collect</h2>
          ...
          <div className="privacy-block mb-8">
            <h2 className="text-xl font-semibold text-[#2c2d5a] mb-3">3. How We Collect Information</h2>
          ...
          <div className="privacy-block mb-8">
            <h2 className="text-xl font-semibold text-[#2c2d5a] mb-3">4. How We Use Your Information</h2>
          ...
          <div className="privacy-block mb-8">
            <h2 className="text-xl font-semibold text-[#2c2d5a] mb-3">5. Cookies and Tracking Technologies</h2>
          ...
          <div className="privacy-block mb-8">
            <h2 className="text-xl font-semibold text-[#2c2d5a] mb-3">6. Data Security</h2>
          ...
          <div className="privacy-block mb-8">
            <h2 className="text-xl font-semibold text-[#2c2d5a] mb-3">7. Third-Party Services</h2>
          ...
          <div className="privacy-block mb-8">
            <h2 className="text-xl font-semibold text-[#2c2d5a] mb-3">8. Data Retention</h2>
          ...
          <div className="privacy-block mb-8">
            <h2 className="text-xl font-semibold text-[#2c2d5a] mb-3">9. Your Data Protection Rights</h2>
            ...
            <p>To exercise any of these rights, please contact us at <a href="mailto:cheapcconline@gmail.com" className="text-[#ff3366] hover:text-[#2c2d5a] underline">cheapcconline@gmail.com</a>.</p>
          </div>
          <div className="privacy-block mb-8">
          ...
          <div className="privacy-block mb-8">
            <h2 className="text-xl font-semibold text-[#2c2d5a] mb-3">11. Changes to This Privacy Policy</h2>
          ...
          <div className="privacy-block">
            ...
            <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:cheapcconline@gmail.com" className="text-[#ff3366] hover:text-[#2c2d5a] underline">cheapcconline@gmail.com</a>.</p>
          </div>
        </div>
      </div>
    </section>
