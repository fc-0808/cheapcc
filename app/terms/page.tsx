...
export const metadata: Metadata = {
  title: 'Terms of Service - CheapCC',
  description: 'CheapCC Terms of Service and user agreement. Read our terms and conditions for using the CheapCC Adobe Creative Cloud subscription service.',
  keywords: 'cheapcc terms, adobe cc terms of service, creative cloud terms, cheapcc user agreement',
};
