              ...
              >
                <Link href={`/blog/${post.slug}`} prefetch={false} className="block h-full group">
                  ...
                  <div className="p-6">
                    ...
                    <h2 className="text-xl font-bold text-white mb-3 line-clamp-2 group-hover:text-[#ff3366] transition-colors duration-300 flex items-center">
                      <span className="w-6 h-6 mr-2 flex-shrink-0 text-[#ff3366]">
