        ...
        <div className="refund-content max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="refund-block mb-8">
            ...
            <ol className="list-decimal pl-6">
              <li>Contact our support team at <a href="mailto:cheapcconline@gmail.com" className="text-[#ff3366] hover:text-[#2c2d5a] underline">cheapcconline@gmail.com</a> within 7 days of your purchase.</li>
          ...
          <div className="refund-block">
            ...
            <p>If you have any questions about our Refund Policy, please contact our support team at <a href="mailto:cheapcconline@gmail.com" className="text-[#ff3366] hover:text-[#2c2d5a] underline">cheapcconline@gmail.com</a>.</p>
          </div>
        </div>
      </div>
    </section>
